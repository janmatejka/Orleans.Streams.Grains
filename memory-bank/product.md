...
- [GrainsQueueAdapterFactory](../Orleans.Streams.Grains/GrainsQueueAdapterFactory.cs) sklada mapper, cache a queue service.
- [GrainsStreamOptions](../Orleans.Streams.Grains/GrainsStreamOptions.cs) umoznuji konfigurovat pocet queues globalne i per namespace.
...
- Test projekt je pripraven, ale chybi implementovane testy.
